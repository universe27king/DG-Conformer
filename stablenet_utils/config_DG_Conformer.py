...
# parser.add_argument('-data', metavar='DIR', default='E:\StableNet-main\DATA',
...
parser.add_argument ('--lrbl', type = float, default = 0.1, help = 'learning rate of balance')

# parser.add_argument ('--cfs', type = int, default = 512, help = 'the dim of each feature')
parser.add_argument ('--lambdap', type = float, default = 7.0, help = 'weight decay for weight1 ')
parser.add_argument ('--lambdapre', type = float, default = 1, help = 'weight for pre_weight1 ')

parser.add_argument ('--epochb', type = int, default = 10, help = 'number of epochs to balance')
